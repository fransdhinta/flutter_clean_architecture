...
import 'package:flutter_clean_architecture/presentation/pages/comment/list_comment_screen.dart';
import 'package:flutter_clean_architecture/presentation/pages/user/create_user_screen.dart';
import 'package:flutter_clean_architecture/presentation/pages/post/list_post_screen.dart';
import 'package:flutter_clean_architecture/presentation/pages/user/detail_user_screen.dart';
import 'package:flutter_clean_architecture/presentation/pages/user/list_user_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) => git.locator<CreateUserCubit>()..init(),
        ),
        BlocProvider(
          create: (_) => git.locator<DetailUserCubit>(),
        ),
        BlocProvider(
          create: (_) => git.locator<ListUserCubit>(),
        ),
        BlocProvider(
          create: (_) => git.locator<ListCommentCubit>(),
        ),
        BlocProvider(
          create: (_) => git.locator<ListPostCubit>(),
        ),
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
